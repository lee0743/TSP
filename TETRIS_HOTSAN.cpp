// TETRIS_HOTSAN.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
#include <Windows.h>

#include "framework.h"
#include "TETRIS_HOTSAN.h"
                     ...
                     _In_ int       nCmdShow)
{
	...
	BitmapImage* blockImage = new BitmapImage();
	if (TRUE == blockImage->Load24BitsBitmap("./assets/redBlock.bmp"))
	{
		__debugbreak();
	}
	delete blockImage;
